...
$güncelle31 = $spexcon->query("UPDATE `bot` SET `tel`='".$no."' WHERE 1 ");
...
<h3><b>SMS API Düzenle</b></h3>
<br>
<form action="" method="POST">
<label><b>Mesajın Geleceği Numarayı Yazınız.</b></label> <br>
<code><label>Örn : 5555555555</label></code>
<input type="text" name="no" class="input-group-text" placeholder="Numara" maxlength="13" required><br>
