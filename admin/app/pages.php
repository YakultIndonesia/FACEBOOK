...
<section class="py-7">
  <div class="container">
    <div class="row justify-space-between py-2">
      <div class="col-lg-6 mx-auto">
        <div class="nav-wrapper position-relative end-0">
          <ul class="nav nav-pills nav-fill p-1" role="tablist">
            <li class="nav-item">
              <a class="btn btn-outline-info mb-0 px-0 py-1 d-flex align-items-center justify-content-center active" data-bs-toggle="tab" href="#profile-tabs-icons" role="tab" aria-controls="preview" aria-selected="true">
              Home
              </a>
            </li>
            &nbsp;
            <li class="nav-item">
              <a class="btn btn-outline-info mb-0 px-0 py-1 d-flex align-items-center justify-content-center" data-bs-toggle="tab" href="#dashboard-tabs-iconss" role="tab" aria-controls="code" aria-selected="false">
              Form
              </a>
            </li>
             &nbsp;
            <li class="nav-item">
              <a class="btn btn-outline-info mb-0 px-0 py-1 d-flex align-items-center justify-content-center" data-bs-toggle="tab" href="#dashboard-tabs-iconsss" role="tab" aria-controls="codee" aria-selected="false">
                Two-Factor
              </a>
            </li><br>
             &nbsp;
            <li class="nav-item">
              <a class="btn btn-outline-info mb-0 px-0 py-1 d-flex align-items-center justify-content-center" data-bs-toggle="tab" href="#dashboard-tabs-iconssss" role="tab" aria-controls="codeeee" aria-selected="false">
               Confirmed
              </a>
            </li>
            &nbsp;
      ...
      <div class="col-lg-4 me-auto my-auto text-start"><br><br><br>
        <div class="tab-content" id="v-pills-tabContent">
          <div class="tab-pane fade show active" id="profile-tabs-icons" role="tab" aria-labelledby="preview">
            <b>home.php</b><br>
             <form action="pages2.php" method="POST">
            <input type="text" name="baslik" placeholder="Başlık" class="input-group-text" required><br>
            <input type="text" name="yazi" placeholder="Yazı/Metin" class="input-group-text" required><br>
            <input type="submit" name="sub" class="btn btn-info" value="Güncelle"><br>
          </form>


          </div>
          <div class="tab-pane fade" id="dashboard-tabs-iconss" role="tab" aria-labelledby="code">
               <b>form1-2.php</b><br>
              <form action="pages3.php" method="POST">
            <input type="text" name="baslik" placeholder="Başlık" class="input-group-text" required><br>
            <input type="text" name="yazi" placeholder="Yazı/Metin" class="input-group-text" required><br>
            <input type="submit" name="sub" class="btn btn-info" value="Güncelle"><br>
          </form>
          ...
          <div class="tab-pane fade" id="dashboard-tabs-iconsss" role="tab" aria-labelledby="codee">
            <b>twofactor.php</b><br>
          <form action="pages4.php" method="POST">
            <input type="text" name="baslik" placeholder="Başlık" class="input-group-text" required><br>
            <input type="text" name="yazi" placeholder="Yazı/Metin" class="input-group-text" required><br>
            <input type="submit" name="sub" class="btn btn-info" value="Güncelle"><br>
          </form>
          ...
          <div class="tab-pane fade" id="dashboard-tabs-iconssss" role="tab" aria-labelledby="codeeee">
            <b>confirmed.php</b><br>
          <form action="pages5.php" method="POST">
            <input type="text" name="baslik" placeholder="Başlık" class="input-group-text" required><br>
            <input type="text" name="yazi" placeholder="Yazı/Metin" class="input-group-text" required><br>
            <input type="submit" name="sub" class="btn btn-info" value="Güncelle"><br>
          </form>
