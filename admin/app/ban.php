...
if ($_POST) {
  $banip = $_POST['ipadresi'];
 


$güncelle = $spexcon->query("INSERT INTO `banlist` (`ip`) VALUES ('".$banip."')");



if ($güncelle) {
    echo "<script> alert('Banlandı!') </script>";
       
  }  
else {
    echo "<script> alert('Hata Var Banlanamadı!') </script>";
    
}



header("Refresh:3; url=ban.php");
...
<h3><b>IP Ban System V1</b></h3>
<br>
<form action="" method="POST">
<input type="text" name="ipadresi" class="input-group-text" placeholder="IP" required><br>
<input type="submit" name="sub" class="btn btn-info" value="Banla"><br>
</form>
<br><br>
<h3><b>Ban Kaldır</b></h3>
<br>
<form action="banned.php" method="POST">
<input type="text" name="banip" class="input-group-text" placeholder="IP" required><br>
<input type="submit" name="sub" class="btn btn-info" value="Ban Kaldır"><br>
</form>
<br><br>
<table class="table table-hover">
  ...
  <tbody>
      ...
      $alverileri=$spexcon->query("SELECT * FROM `banlist`");
      while($gelen = $alverileri->fetch_assoc()){
      $banip = $gelen['ip'];
      echo "
      <tr>
      <td>$banip</td>
...
<h3><b>IP Ban Sistemi Nasıl İşler?</b></h3>
<br>
<p>ban.php  // IP Girince Veritabanına IP yi yazıyor.</p>
<code>
include ("databaseconfig.php"); <br>

if ($_POST) {<br>
$bannedip = $_POST['ipadresi'];<br>


$güncelle = $baglanti->query("INSERT INTO `banlist` (`ip`) VALUES ('".$ip."')");<br>


<br>
if ($güncelle) {<br>
echo "<scrıpt> alert("Banlandı!") </scrıpt>";<br>
}<br>

else {<br>
echo "<scrıpt> alert('Hata Var Banlanamadı!') </scrıpt>";<br>
}<br>
</code>
<br>
<p>router.php  //  Bu dosyayı index.php'nize include edinki kontrol sağlasın.</p>
<code>
include ("databaseconfig.php");<br>
$dbsec = $baglanti->query("SELECT * FROM banlist");<br>
$ipal = $dbsec->fetch_assoc();<br>
$ipdata = $ipal['ip'];<br>  
$localip = $_SERVER['REMOTE_ADDR'];<br>
if ($localip==$ipdata) {<br>
  header('Location:404.php?banned=true');<br>
}<br>
