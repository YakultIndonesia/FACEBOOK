...
$sitebaslik = $_GET['baslik'];
$siteaciklama = $_GET['aciklama'];

$güncelle = $spexcon->query("UPDATE `tag` SET `sitebaslik`='".$sitebaslik."',`siteaciklama`='".$siteaciklama."' WHERE 1");
   ...
   <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="content">
          ...
          <h3><b>Site Ayarları</b></h3>
          <br>
          <form  method="GET">
          <input type="text" name="baslik" class="input-group-text" placeholder="Site Başlık" required><br>
          <input type="text" name="aciklama" class="input-group-text" placeholder="Site Açıklama" required><br>
          <input type="submit" name="sub" class="btn btn-info" value="Güncelle">
        </form>
<br><br>
...
*/?>
        ...
        <h4><b>Mevcut Ayarlar</b></h4><br>
        <textarea type="text" name="baslik" class="input-group-text" placeholder="<?php echo $baslik; ?>" disabled></textarea><br>
        <textarea type="text" name="aciklama" class="input-group-text" placeholder="<?php echo $aciklama; ?>" disabled></textarea><br>
        <hr>
