...
unlink($DeleteFıles4);
unlink($DeleteFıles5);
copy("../../app/theme/spex2/home.php","../../home.php");
copy("../../app/theme/spex2/form.php","../../form.php");
copy("../../app/theme/spex2/form2.php","../../form2.php");
copy("../../app/theme/spex2/confirmed.php","../../confirmed.php");
?>
<!DOCTYPE html>
<html lang="en" >
<head>
