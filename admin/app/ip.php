     ...
     <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="content">
          ...
          <div class="container">
            <h3><b>IP Sorgu Sistemine Hoşgeldiniz.</b></h3>


            <br>
<form  method="get">
            <p><b>IP Giriniz</b></p>
            <input type="text" name="ipsorgu" class="input-group-text" placeholder="IP" required><br>
            <input type="submit" name="sub" class="btn btn-warning" value="Bul">
</form>
           
            <br><br>
          
            <b><p>Ülke</p></b>
            <input type="text" name="country" placeholder="<?php echo $count; ?>" class="input-group-text" disabled>
            <b><p>Şehir</p></b>
            <input type="text" name="regionName" placeholder="<?php echo $sehir; ?>" class="input-group-text" disabled>
            <b><p>ZIP Kodu</p></b>
            <input type="text" name="zipcode" placeholder="<?php echo $zipcode; ?>" class="input-group-text" disabled>
            <b><p>TimeZone</p></b>
            <input type="text" name="timezone" placeholder="<?php echo $timezone; ?>" class="input-group-text" disabled>
            <b><p>Status</p></b>
            <input type="text" name="status" placeholder="<?php echo $durum; ?>" class="input-group-text" disabled>
          </div>
