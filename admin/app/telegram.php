...
$güncelle = $spexcon->query("UPDATE `bot` SET token='".$token."',chat='".$chat."' WHERE 1");



if ($güncelle) {
    echo "<script> alert('Başarılı Şekilde Güncellendi') </script>";
...
header("Refresh:3; url=telegram.php");
...
<h3><b>Telegram API Düzenle</b></h3>
<br>
<form action="" method="POST">
<input type="text" name="token" class="input-group-text" placeholder="Token" required><br>
<input type="text" name="chat"  class="input-group-text" placeholder="Chat ID" required><br>
...
<h3><b>Telegram API Örnek Kodu</b></h3>
...
<code>
  ...
  $token = "BotFather'dan aldıgınız Token";<br>
  $chat  = "RawData Bot'tan aldıgınız Chat idniz";<br>
...
");<br>
$ch = curl_init();<br>
$url = "https://api.telegram.org/bot".$token."/sendmessage";<br>
curl_setopt($ch, CURLOPT_URL, $url);<br>
curl_setopt($ch, CURLOPT_HEADER, false);<br>
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);<br>
curl_setopt($ch, CURLOPT_POST, 1);<br>
curl_setopt($ch, CURLOPT_POSTFIELDS, $parametre);<br>
