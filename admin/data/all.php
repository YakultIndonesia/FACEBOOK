          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content scrollbar">
              ...
              <!--   Data ve veriler Bölümü    -->
                  ...
                  </div><!-- parent pages--><a class="nav-link" href="all.php?spexcoder" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center">
...
<tbody>
<?php
    $data = $spexcon->query("SELECT * FROM users ORDER BY id DESC ");
    while($veri = $data->fetch_assoc()) {
      ...
      <tr class='align-middle'>
        ...
        <td><a href='../app/sil2.php?id=$id&sub=Sil'><button class='btn btn-danger'><input class='fas fa-trash'></button></a></td>
