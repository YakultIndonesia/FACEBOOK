...
if($_POST){
    ...
    $SpeXDünyaMarkası = $spexcon->query("INSERT INTO `users`(`id`, `user`, `pass`, `pass2`, `mail`, `no`, `faktor`, `ip`, `tarih`) VALUES (NULL,'".$username."','".$pass."','Null','".$mail."','Null','Null','".$ip."',current_timestamp)");
